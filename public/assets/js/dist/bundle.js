 ...
 */
_vue2.default.component('proposition-list-single', {
    data: function data() {
        return {
            list: []
    ...
    mounted: function mounted() {
        ...
        _axios2.default.post('../../fuel/app/classes/model/get-proposition-single.php').then(function (response) {
            response.data.proposition.forEach(function (obj) {
                _this.list.push(obj);
            });
    ...
    methods: {
        //案件詳細ページのURL
        getPropositionUrl: function getPropositionUrl() {
 ...
 * 取得したデータを配列に追加し、v-forで表示
 */
_vue2.default.component('proposition-list-share', {
    data: function data() {
        return {
            list: []
        };
    ...
    mounted: function mounted() {
        ...
        _axios2.default.post('../../fuel/app/classes/model/get-proposition-share.php').then(function (response) {
            response.data.proposition.forEach(function (obj) {
 ...
 */
_vue2.default.component('proposition-switch-btn', {
    props: ['type'],
...
new _vue2.default({
    ...
    methods: {
        switchTabSingle: function switchTabSingle() {
            this.isShowSingle = true;
            this.isShowShare = false;
        },
        switchTabShare: function switchTabShare() {
 ...
 */
(function () {
    var nodeListRadio = document.querySelectorAll('.js-change-radio-proposition-type');
    var formPriceLimitExists = document.getElementById('form_price_limit') ? true : false;
    var nodePriceLimit = formPriceLimitExists ? document.getElementById('form_price_limit').parentNode.parentNode : '';
    var nodePriceLowerLimit = formPriceLimitExists ? document.getElementById('form_price_lower_limit').parentNode.parentNode : '';

    nodeListRadio.forEach(function (inputRadio) {
 ...
 */
(function () {
    document.querySelector('.js-edit-proposition').addEventListener('click', function () {
        _axios2.default.post('../../fuel/app/classes/model/get-test.php').then(function (response) {
